<?php
    ...
    function _GetSkillID($skill, $locale) {
        switch($locale) {
            case "FRFR": {
                switch($skill) {
    ...
    function _getFactionNameFromID($FactionID) {
        switch($FactionID) {
            case 21: return "BOOTY BAY";
            case 47: return "IRONFORGE";
            case 54: return "GNOMEREGAN EXILES";
            case 59: return "THORIUM BROTHERHOOD";
            case 68: return "UNDERCITY";
            case 69: return "DARNASSUS";
            case 70: return "SYNDICATE";
            case 72: return "STORMWIND";
            case 76: return "ORGRIMMAR";
            case 81: return "THUNDER BLUFF";
            case 87: return "BLOODSAIL BUCCANEERS";
            case 92: return "GELKIS CLAN CENTAUR";
            case 93: return "MAGRAM CLAN CENTAUR";
            case 270: return "ZANDALAR TRIBE";
            case 349: return "RAVENHOLDT";
            case 369: return "GADGETZAN";
            case 470: return "RATCHET";
            case 509: return "THE LEAGUE OF ARATHOR";
            case 510: return "THE DEFILERS";
            case 529: return "ARGENT DAWN";
            case 530: return "DARKSPEAR TROLLS";
            case 576: return "TIMBERMAW HOLD";
            case 577: return "EVERLOOK";
            case 589: return "WINTERSABER TRAINERS";
            case 609: return "CENARION CIRCLE";
            case 729: return "FROSTWOLF CLAN";
            case 730: return "STORMPIKE GUARD";
            case 749: return "HYDRAXIAN WATERLORDS";
            case 809: return "SHEN'DRALAR";
            case 890: return "SILVERWING SENTINELS";
            case 909: return "DARKMOON FAIRE";
            case 910: return "BROOD OF NOZDORMU";
            case 911: return "SILVERMOON CITY";
            case 922: return "TRANQUILLIEN";
            case 930: return "EXODAR";
            case 932: return "THE ALDOR";
            case 933: return "THE CONSORTIUM";
            case 934: return "THE SCRYERS";
            case 935: return "THE SHA'TAR";
            case 936: return "SHATTRATH CITY";
            case 941: return "THE MAG'HAR";
            case 942: return "CENARION EXPEDITION";
            case 946: return "HONOR HOLD";
            case 967: return "THE VIOLET EYE";
            case 970: return "SPOREGGAR";
            case 978: return "KURENAI";
            case 989: return "KEEPERS OF TIME";
            case 990: return "THE SCALE OF THE SANDS";
            case 1011: return "LOWER CITY";
            case 1012: return "ASHTONGUE DEATHSWORN";
            case 1015: return "NETHERWING";
            case 1031: return "SHA'TARI SKYGUARD";
            case 1037: return "ALLIANCE VANGUARD";
            case 1038: return "OGRI'LA";
            case 1050: return "VALIANCE EXPEDITION";
            case 1052: return "HORDE EXPEDITION";
            case 1064: return "THE TAUNKA";
            case 1067: return "THE HAND OF VENGEANCE";
            case 1068: return "EXPLORERS' LEAGUE";
            case 1073: return "THE KALU'AK";
            case 1077: return "SHATTERED SUN OFFENSIVE";
            case 1085: return "WARSONG OFFENSIVE";
            case 1090: return "KIRIN TOR";
            case 1091: return "THE WYRMREST ACCORD";
            case 1094: return "THE SILVER COVENANT";
            case 1098: return "KNIGHTS OF THE EBON BLADE";
            case 1104: return "FRENZYHEART TRIBE";
            case 1105: return "THE ORACLES";
            case 1106: return "ARGENT CRUSADE";
            case 1119: return "THE SONS OF HODIR";
            case 1124: return "THE SUNREAVERS";
            case 1126: return "THE FROSTBORN";
            case 1145: return "HATES EVERYTHING";
            case 1156: return "THE ASHEN VERDICT";
            default: return -1;
        }
    }
    ...
    function _isSpellValid($SpellID, $ClassID) {
        if(_isClassSpellValid($SpellID, $ClassID))
            return true;
        else if(_isProfessionSpell($SpellID))
            return true;
        return false;
    }
?>